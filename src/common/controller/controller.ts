...
import { STATIC_RESOURSE_FIELDS } from '../../app/application.constant.js';
...
export abstract class Controller implements ControllerInterface {
  ...
  public addRoute(route: RouteInterface) {
    ...
    this.logger.info(`Route has been registered: ${route.method.toUpperCase()} ${route.path}`);
  }
